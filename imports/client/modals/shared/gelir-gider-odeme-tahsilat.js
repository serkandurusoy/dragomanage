...
import { iptalOnayiSchema,gelirTahsilatCombineSchema } from '/imports/environment/schema-globals';
...
import {
  ...
  CARI_KARTLAR,
  CINSIYETLER,
  DALIS_SERTIFIKALARI, DALIS_SEVIYELERI,
  DILLER,
  SEKAYAK_SEVIYELERI,
  ULKELER
} from "../../../environment/enums";
import { Kasalar } from "../../../api/model";
  ...
  return {
    ...
    render() {
      ...
      return <AutoForm
        ...
        schema={!updateForm ? schema.extend(gelirTahsilatCombineSchema) : new SimpleSchema(schema).extend(iptalOnayiSchema)}
        ...
        <BoolField
          ...
          transform={v => v === true ? 'Evet' : 'Hayır'}
          showInlineError
          name="tahsilatBirlikte" />
        <DisplayIfField condition={model => model.tahsilatBirlikte === true}>
          <div>
            <Row>
                  <Col sm={4}>
                    <NumberField
